...
namespace TDC{
  enum LocalAddress
    {
     kAddrEnableBlock   = 0x20000000, // W/R, [7:0]  Block enable (0:3-Leading, 4:7-Trailing)
     kAddrPtrOfs        = 0x20100000, // W/R, [10:0] Offset read pointer
     kAddrWindowMax     = 0x20200000, // W/R, [10:0] Search window max
     kAddrWindowMin     = 0x20300000  // W/R, [10:0] Search window min
    };
};
